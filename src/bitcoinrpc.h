...
#ifndef _BartCoinRPC_H_
#define _BartCoinRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // BartCoin is not connected
...
/**
 * BartCoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern json_spirit::Value getpowheight(const json_spirit::Array& params, bool fHelp);
